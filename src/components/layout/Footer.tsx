        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex">
                <MapPin className="h-5 w-5 text-estate-300 mt-1 mr-3" />
                <span className="text-estate-300">Doha, Qatar</span>
              </li>
              <li className="flex">
                <Phone className="h-5 w-5 text-estate-300 mt-1 mr-3" />
                <span className="text-estate-300">+ 123 45 67 89</span>
              </li>
              <li className="flex">
                <Mail className="h-5 w-5 text-estate-300 mt-1 mr-3" />
                <span className="text-estate-300">testing@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="border-t border-estate-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-estate-400">© 2024 Babut Estate Services. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-sm text-estate-400 hover:text-white transition-colors">
                Terms & Conditions
              </a>
              <a href="#" className="text-sm text-estate-400 hover:text-white transition-colors">
                Privacy Policy
